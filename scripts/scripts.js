...
(function () {
  ...
  function pickLetter() {
    ...
    letterPicked.removeClass("letter-button").addClass("letter-disabled");
  ...
  var hangmanWords = ["ultrasonicsensor"];
  ...
  function setWordToBeGuessed() {
    ...
    currentWord.split("").map(function (character,ind) {
      ...
      if(ind===9){
        let brakey = document.createElement("br")
        guessWordBlock.appendChild(brakey)
      }
    });
  }
